...
-- Note: Since user_id was previously NOT NULL, all existing listings should have user_id set.
-- This constraint protects against future inserts/updates that might leave both NULL.
ALTER TABLE public.listings 
